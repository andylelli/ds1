...
async function runTest() {
    ...
    // Inject signals
    (agent as any).collectedSignals = [...signalsA, ...signalsB];
    ...
    const scoreA = ranked.find((t: any) => t.id === 't1')?.score || 0;
    const scoreB = ranked.find((t: any) => t.id === 't2')?.score || 0;
