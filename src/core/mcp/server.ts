...
export class MCPServer {
  ...
  protected resources: Map<string, Function>;
  ...
  async handleResourceRead(message: any) {
  ...
  sendResult(id: string | number | null | undefined, result: any) {
  ...
  sendError(id: string | number | null | undefined, code: number, message: string) {
      if (id === undefined || id === null) return;
      const response = {
          jsonrpc: '2.0',
          id,
